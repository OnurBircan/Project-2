...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        img_obstacle = Image.open("td_learning/images/obstacle.png")
        self.obstacle_object = ImageTk.PhotoImage(img_obstacle)

        img_tree = Image.open("td_learning/images/tree.png")
        self.tree_object = ImageTk.PhotoImage(img_tree)

        img_shop = Image.open("td_learning/images/boot_tree.png")
        self.shop_object = ImageTk.PhotoImage(img_shop)

        img_building = Image.open("td_learning/images/building.png")
        self.building_object = ImageTk.PhotoImage(img_building)

        img_cube = Image.open("td_learning/images/rubik.png")
        self.cube_object = ImageTk.PhotoImage(img_cube)

        img_garbage = Image.open("td_learning/images/garbage.png")
        ...
        img_flag = Image.open("td_learning/images/flag.png")
        ...
        img_robot = Image.open("td_learning/images/agent.png")
        ...
        self.obstacles = [self.canvas_widget.coords(self.obstacle1),
    ...
    def policy(self, state):
        '''
        choosing teh best action based on current state of the agent
        '''
        # right
        if list(map(add, state, [40, 0])) in self.obstacles:
            action = np.random.choice([0, 1, 3])
        elif list(map(add, state, [-40, 0])) in self.obstacles:
            action = np.random.choice([0, 1, 2])
        # down
        elif list(map(add, state, [0, 40])) in self.obstacles:
