...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        img_obstacle = Image.open("sarsa/images/obstacle.png")
        self.obstacle_object = ImageTk.PhotoImage(img_obstacle)

        img_tree = Image.open("sarsa/images/tree.png")
        self.tree_object = ImageTk.PhotoImage(img_tree)

        img_shop = Image.open("sarsa/images/boot_tree.png")
        self.shop_object = ImageTk.PhotoImage(img_shop)

        img_building = Image.open("sarsa/images/building.png")
        self.building_object = ImageTk.PhotoImage(img_building)

        img_cube = Image.open("sarsa/images/rubik.png")
        self.cube_object = ImageTk.PhotoImage(img_cube)

        img_garbage = Image.open("sarsa/images/garbage.png")
        ...
        img_flag = Image.open("sarsa/images/flag.png")
        ...
        img_robot = Image.open("sarsa/images/agent.png")
