...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        img_obstacle = Image.open('q_learning/images/obstacle.png')  
        self.obstacle_object = ImageTk.PhotoImage(img_obstacle)

        img_tree = Image.open('q_learning/images/tree.png')
        self.tree_object = ImageTk.PhotoImage(img_tree)

        img_shop = Image.open('q_learning/images/boot_tree.png')
        self.shop_object = ImageTk.PhotoImage(img_shop)

        img_building = Image.open('q_learning/images/building.png')
        self.building_object = ImageTk.PhotoImage(img_building)

        img_cube = Image.open('q_learning/images/rubik.png')
        self.cube_object = ImageTk.PhotoImage(img_cube)

        img_garbage = Image.open('q_learning/images/garbage.png')
        ...
        img_flag = Image.open('q_learning/images/flag.png')
        ...
        img_robot = Image.open('q_learning/images/agent.png')
