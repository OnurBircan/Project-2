from env_cliff import Environment
from algo_qlearning import QLearning
from algo_sarsa import SARSA
from algo_double_qlearning import Double_QLearning
...
for episode in range(episodes):
    ...
    while True:
        ...
        value2 += SARSA.learning(str(state2), action2,
                                 reward2, str(next_state2), next_action2)
        state2 = next_state2
...
for episode in range(episodes):
    ...
    while True:
        ...
        value13, value23 = DQL.learning(
            str(state3), action3, reward3, str(next_state3))
        value13 += value13
        value23 += value23
        state3 = next_state3
        step3 += 1
